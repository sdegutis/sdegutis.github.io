...
Using WebKit.framework, a basic browser can be whipped up relatively quickly, even with 0 lines of code. But WebKit itself doesn't contain some conveniences I _do_ want.
...
A tabbed interface is optional to me, as long as I can have multiple windows open. Complex tabs are still a very new creature and adding them into an app like this is likely to ruin it from the beginning, since we as users don't even know _how we want them to behave in the first place_.
