---
title: "Rationale behind my MGTwitterEngine replacement"
---
...
* Navigate to the service's API page for that task (let's use [mentions](http://apiwiki.twitter.com/Twitter-REST-API-Method%3A-statuses-mentions) as an example)
