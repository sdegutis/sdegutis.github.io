---
title: "TypeScript should be the future of iOS"
---
...
The rest of the code doesn’t need to be very fast. It’s more important that it is simple, easy, and has high-level abstractions. This is why I think Apple would be wise to make JavaScript a first class language for the iOS platforms moving forward. If it wants to keep the type safety, then it could integrate TypeScript. There’s already very good IDE support for it in VS Code, all of which is open source, so Apple could integrate that into Xcode. (I’m fully aware of the irony of suggesting that Apple use something Microsoft made, but that doesn’t automatically make it a bad idea! They should use the right tool for the job.)

This way, for the tight spots where performance is a concern, they can still be written in C, and Apple can even create a little bridge where C code can be automatically called from JavaScript, and types are converted automatically. They already did this with Swift, surely they can do it again with JavaScript!
