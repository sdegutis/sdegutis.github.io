import { Html } from "../../components/page/page";
      ...
      body: renderElement(<>
        <Html>
          ...
          <head>
            ...
            <title>Steven Degutis: Front-end Software Developer</title>
            <Stylesheet src={staticRouteFor(__dir.filesByName['resume.css']!)} />
          </head>
          ...
          <body>
            ...
            <main id="root">
              ...
              <header>
                <img src={staticRouteFor(__dir.filesByName['profile.jpg']!)} />
                <h1>Steven Degutis</h1>
                <h2 class="employment-title">Front-end Software Developer</h2>
                <p><a href="mailto:sbdegutis@gmail.com">sbdegutis@gmail.com</a></p>
              </header>
